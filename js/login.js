...
// Mostrar a mensagem de login  de bem-sucedido
...
function showLoginSuccess() {
  ...
  button.innerHTML =
    '<i class="bi bi-check-circle"></i> Login realizado com sucesso!';
...
// Vai Ativar ou desativar modo escuro
...
function toggleDarkMode() {
  ...
  console.log(
    darkModeEnabled ? "🌙 Modo escuro ativado!" : "☀️ Modo claro ativado!"
  );
}

// Detecta sequência de teclas Konami para ativar modo escuro
